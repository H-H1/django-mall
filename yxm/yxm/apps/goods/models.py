...
class GoodsCategory(BaseModel):
    ...
    clogo = models.ImageField(null=True, blank=True, verbose_name='分类图片')
...
class Goods(BaseModel):
    ...
    brand = models.ForeignKey(Brand, null=True, on_delete=models.SET_NULL, verbose_name='品牌')
...
class SKU(BaseModel):
    ...
    cost_price = models.DecimalField(max_digits=10, decimal_places=2, default=0, verbose_name='进价')
