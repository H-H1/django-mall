    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promocode', models.CharField(blank=True, max_length=11, null=True, unique=True, verbose_name='推广码')),
                ('promocoer', models.CharField(default=0, max_length=11, verbose_name='推广人ID')),
                ('email_active', models.BooleanField(default=False, verbose_name='邮箱验证状态')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to=['avatar'], verbose_name='头像图片')),
            ],
            options={
                'verbose_name': '用户',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='u', to='users.Address', verbose_name='默认地址'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
